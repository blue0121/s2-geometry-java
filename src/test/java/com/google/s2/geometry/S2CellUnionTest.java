...
public strictfp class S2CellUnionTest extends BaseTest {
  ...
  public void testAverageBasedArea() {
    ...
    // empty union
    assertEquals(0.0, cellUnion.averageBasedArea(), 0.01);
    ...
    assertEquals(expected, cellUnion.averageBasedArea(), 0.01);
  }
  ...
  public void testApproxArea() {
    ...
    // empty union
    assertEquals(0.0, cellUnion.approxArea(), 0.01);
    ...
    assertEquals(expected, cellUnion.approxArea(), 0.01);
  }
  ...
  public void testExactArea() {
    ...
    // empty union
    assertEquals(0.0, cellUnion.exactArea(), 0.01);
