...
public strictfp class S2CapTest extends BaseTest {
  ...
  public void testBasic() {
    ...
    assertEquals(full.height(), 2.0, 0.01);
    ...
    assertEquals(xaxis.angle().radians(), 0.0, 0.01);
    ...
    assertEquals(xaxis.height(), 0.0, 0.01);
    ...
    assertEquals(hemi.complement().height(), 1.0, 0.01);
