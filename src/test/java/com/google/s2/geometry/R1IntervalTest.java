...
public strictfp class R1IntervalTest extends BaseTest {
  ...
  public void testBasic() {
    ...
    assertEquals(unit.lo(), 0.0, 0.01);
    assertEquals(unit.hi(), 1.0, 0.01);
    assertEquals(negunit.lo(), -1.0, 0.01);
    assertEquals(negunit.hi(), 0.0, 0.01);
    ...
    // GetCenter(), GetLength()
    assertEquals(unit.getCenter(), 0.5, 0.01);
    assertEquals(half.getCenter(), 0.5, 0.01);
    assertEquals(negunit.getLength(), 1.0, 0.01);
    assertEquals(half.getLength(), 0.0, 0.01);
