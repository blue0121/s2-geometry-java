 ...
 */
package com.google.s2.geometry;
...
public strictfp class S1IntervalTest extends BaseTest {
  ...
  public void testBasic() {
    ...
    assertEquals(quad12.lo(), 0.0, 0.01);
    assertEquals(quad12.hi(), S2.M_PI, 0.01);
    S1Interval quad34 = new S1Interval(-S2.M_PI, 0);
    assertEquals(quad34.lo(), S2.M_PI, 0.01);
    assertEquals(quad34.hi(), 0.0, 0.01);
    S1Interval pi = new S1Interval(S2.M_PI, S2.M_PI);
    assertEquals(pi.lo(), S2.M_PI, 0.01);
    assertEquals(pi.hi(), S2.M_PI, 0.01);
    S1Interval mipi = new S1Interval(-S2.M_PI, -S2.M_PI);
    assertEquals(mipi.lo(), S2.M_PI, 0.01);
    assertEquals(mipi.hi(), S2.M_PI, 0.01);
    S1Interval quad23 = new S1Interval(S2.M_PI_2, -S2.M_PI_2); // inverted
    assertEquals(quad23.lo(), S2.M_PI_2, 0.01);
    assertEquals(quad23.hi(), -S2.M_PI_2, 0.01);
    ...
    // GetCenter(), GetLength()
    assertEquals(quad12.getCenter(), S2.M_PI_2, 0.01);
    assertEquals(quad12.getLength(), S2.M_PI, 0.01);
    ...
    assertEquals(pi.getCenter(), S2.M_PI, 0.01);
    assertEquals(pi.getLength(), 0.0, 0.01);
    assertEquals(mipi.getCenter(), S2.M_PI, 0.01);
    assertEquals(mipi.getLength(), 0.0, 0.01);
    assertEquals(Math.abs(quad23.getCenter()), S2.M_PI, 0.01);
    assertEquals(Math.abs(quad23.getLength()), S2.M_PI, 0.01);
    S1Interval quad123 = new S1Interval(0, -S2.M_PI_2);
    assertDoubleNear(quad123.getCenter(), 0.75 * S2.M_PI, 0.01);
    assertDoubleNear(quad123.getLength(), 1.5 * S2.M_PI, 0.01);
    assertTrue(empty.getLength() < 0);
    assertEquals(full.getLength(), 2 * S2.M_PI, 0.01);
