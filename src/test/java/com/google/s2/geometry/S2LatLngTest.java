...
public strictfp class S2LatLngTest extends BaseTest {
  ...
  public void testConversion() {
    ...
    assertEquals(
        new S2LatLng(S2LatLng.fromRadians(-S2.M_PI_2, 1).toPoint()).lat().radians(), -S2.M_PI_2, 0.01);
    assertDoubleNear(
  ...
  public void testDistance() {
    assertEquals(
        S2LatLng.fromDegrees(90, 0).getDistance(S2LatLng.fromDegrees(90, 0)).radians(), 0.0, 0.01);
    assertDoubleNear(
